...
public class PathCalculatorTest {
    ...
    public void testMinimumDistance() throws Exception {
        Path path = PathCalculator.calculateShortestPath(field, new Point(5, 0), new Point(17, 0), null, null, null, field.getOpponentId());
    ...
    public void testMinimumDistance2() throws Exception {
        Path path = PathCalculator.calculateShortestPath(field, new Point(0, 5), new Point(17, 3), null, null, null, field.getOpponentId());
        int distance = path.getDistance();
    ...
    public void testMinimumDistance3() throws Exception {
        Path path = PathCalculator.calculateShortestPath(field, new Point(2, 8), new Point(17, 3), null, null, null, field.getOpponentId());
        int distance = path.getDistance();
